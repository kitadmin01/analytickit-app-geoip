...
import { Plugin, PluginMeta } from '@analytickit/plugin-scaffold'
// @ts-ignore
import { createPageview, resetMeta } from '@analytickit/plugin-scaffold/test/utils'
...
test('error is thrown if meta.geoip is not provided', async () => {
    ...
    await expect(
        ...
        new Error('This AnalyticKit version does not have GeoIP capabilities! Upgrade to AnalyticKit 1.24.0 or later')
    )
})
